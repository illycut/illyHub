...
export default defineConfig({
  ...
  webServer: {
    command: `npm run build && HUB_FAKE_DEVICES=1 HUB_FAKE_TIDAL=1 HUB_FAKE_PANDORA=1 HUB_FAKE_YTMUSIC=1 HUB_AIRPLAY_ENABLED=1 HUB_PORT=${PORT} HUB_APP_DIR=../app/out uv run --project ../hub hub`,
